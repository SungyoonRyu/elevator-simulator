...
public class SimulatorStats {
	...
	public void passengerExited(Elevator elevator, Passenger passenger) {
		this.updatePassengerExited(this.globalInterval, elevator, passenger);
		this.updatePassengerExited(this.currentStatsInterval, elevator, passenger);
		this.updatePassengerExited(this.pollInterval, elevator, passenger);
	 ...
	 * @param passenger The passenger
	 */
	private void updatePassengerExited(StatsInterval statsInterval, Elevator elevator, Passenger passenger) {
		...
		statsInterval.increaseElevatorCarServed(elevator.getId());
	}
