...
public class Scenario {
	...
	private final ElevatorConfiguration elevatorConfiguration;
	
	/**
	 * Creates a new scenario
	 * @param name The name of the scenario
	 * @param numElevatorCars The number of elevator cars
	 * @param elevatorConfiguration The configuration for the elevator car
	 * @param floorResidents The residents on each floor
	 * @param trafficProfile The traffic profile
	 */
	public Scenario(String name, int numElevatorCars, ElevatorConfiguration elevatorConfiguration, int[] floorResidents, TrafficProfile trafficProfile) {
		this.name = name;
	...
	public Building createBuilding() {
		...
		return new Building(floors, this.numElevatorCars, 0, this.elevatorConfiguration);
	}
}
