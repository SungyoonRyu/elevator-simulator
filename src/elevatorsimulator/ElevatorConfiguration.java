...
public class ElevatorConfiguration {
	...
	private static final ElevatorConfiguration DEFAULT_CONFIGURATION = new ElevatorConfiguration(8, 1.5, 2.6, 2.6, 1);
	 ...
	 */
	public ElevatorConfiguration(int capacity, double floorTime, double stopTime, double startTime, double doorTime) {
	 ...
	 * @return
	 */
	public static ElevatorConfiguration defaultConfiguration() {
